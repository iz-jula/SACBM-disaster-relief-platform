        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
            ...
            <div className="flex items-center">
              <img
                src="https://cdn.builder.io/api/v1/image/assets%2Fbd6f78eaf13f40608158a138ec8f1c25%2F3a1a4e655da0467388df0f18259e3a68?format=webp&width=600&height=600"
                alt="Ways You Can Help"
            ...
            <div className="flex flex-col justify-center">
              <h2 className="text-4xl sm:text-5xl font-light tracking-tight text-slate-900 mb-4">Ways You Can Help</h2>
              <p className="text-base text-slate-600 mb-8">
                SACBM identifies critical needs in our communities and calls upon our members and partners to help address them. Here are the key areas where your support makes a difference.
              </p>

              {/* Requirements Grid */}
              <div className="space-y-4">
                {/* Medical Supplies */}
                <div className="rounded-lg border border-slate-200 bg-white p-6 hover:shadow-md hover:border-emerald-300 transition-all">
                  <h3 className="text-lg font-medium text-slate-900 mb-2">Medical Supplies</h3>
                  <p className="text-sm text-slate-600">
                    Essential medical equipment and medications for community health centers and emergency response initiatives.
                  </p>
                </div>

                {/* Educational Materials */}
                <div className="rounded-lg border border-slate-200 bg-white p-6 hover:shadow-md hover:border-emerald-300 transition-all">
                  <h3 className="text-lg font-medium text-slate-900 mb-2">Educational Materials</h3>
                  <p className="text-sm text-slate-600">
                    Books, school supplies, and learning resources to support educational programs in underserved areas.
                  </p>
                </div>

                {/* Emergency Shelter */}
                <div className="rounded-lg border border-slate-200 bg-white p-6 hover:shadow-md hover:border-emerald-300 transition-all">
                  <h3 className="text-lg font-medium text-slate-900 mb-2">Emergency Shelter</h3>
                  <p className="text-sm text-slate-600">
                    Support for disaster relief and temporary shelter solutions for families in crisis situations.
                  </p>
                </div>

                {/* Food & Water */}
                <div className="rounded-lg border border-slate-200 bg-white p-6 hover:shadow-md hover:border-emerald-300 transition-all">
                  <h3 className="text-lg font-medium text-slate-900 mb-2">Food & Water</h3>
                  <p className="text-sm text-slate-600">
                    Nutritious food and clean water access for vulnerable populations and community nutrition programs.
                  </p>
                </div>
              </div>
