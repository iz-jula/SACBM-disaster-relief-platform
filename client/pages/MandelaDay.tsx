      ...
      <main>
        ...
        <section className="border-t border-slate-200 bg-slate-50">
          <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 sm:px-8 lg:grid-cols-[1fr_auto] lg:items-center">
            ...
            <a href="mailto:joao.v@southafricanchamber.co.mz?subject=Mandela Day">
              <Button size="lg" className="bg-orange-700 text-white hover:bg-orange-800">Contact us <ArrowRight className="ml-2 h-4 w-4" /></Button>
            </a>
          </div>
        </section>
      </main>
