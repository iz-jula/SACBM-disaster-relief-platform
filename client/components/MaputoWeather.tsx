            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-6 border border-blue-200">
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <p className="text-sm text-slate-600 mt-1">Low: {currentWeather.low}°C</p>
                </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 pt-4 border-t border-blue-200">
                <div>
                  ...
                  <p className="text-lg font-bold text-slate-900 mt-1">{currentWeather.humidity}%</p>
                </div>
                <div>
                  <p className="text-xs text-slate-600 uppercase tracking-wide">Wind</p>
                  <p className="text-lg font-bold text-slate-900 mt-1">{currentWeather.windSpeed} km/h</p>
                </div>
                <div>
                  <p className="text-xs text-slate-600 uppercase tracking-wide">Rain</p>
                  <p className="text-lg font-bold text-slate-900 mt-1">{currentWeather.rainChance}%</p>
                </div>
              </div>

              <div className="mt-4 p-3 bg-white rounded-lg">
                <p className="text-sm font-semibold text-slate-900">
                  Pressure: {currentWeather.pressure} mb | Visibility: {currentWeather.visibility} km
                </p>
              </div>
            </div>
